...
//-------------------------------------------------------------------------------
- (void)initController {
    maIntroTitles   = [[NSMutableArray alloc] initWithObjects: @"Bienvenido a MyBudged!",
                                                               @"Aprende a aministrar tus ingresos",
                                                               @"Y ahorra dinero!", nil];
    maIntroImgs     = [[NSMutableArray alloc] initWithObjects: @"intro_01.jpg", @"intro_02.png", @"intro_03", nil];
    
    maIncomeAmounts = [[NSMutableArray alloc] init];
    maIncomeTitles = [[NSMutableArray alloc] init];
    
    maExpenseAmounts = [[NSMutableArray alloc] init];
    maExpenseTitles = [[NSMutableArray alloc] init];
